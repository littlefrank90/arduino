...
// fila sopra
  ...
  {.pin = 16, .type = CONSUMER, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 50, .key = {MEDIA_PREVIOUS}}}},
  {.pin = 14, .type = CONSUMER, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 50, .key = {MEDIA_NEXT}}}},
  {.pin =  5, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 0, .key = {KEY_LEFT_GUI, KEY_5}}}}, //open taskbar 5, aka spotify
