...
// fila sopra
  {.pin = 10, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 0, .key = {KEY_RIGHT_CTRL, KEY_INSERT}}}}, //toggle discord mute
  {.pin = 14, .type = CONSUMER, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 50, .key = {MEDIA_PREVIOUS}}}},
  {.pin = 5, .type = CONSUMER, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 50, .key = {MEDIA_NEXT}}}},
  {.pin = 4, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 0, .key = {KEY_LEFT_GUI, KEY_5}}}}, //open taskbar 5, aka spotify
...
// fila sotto
  ...
  {.pin =  7, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 0, .key = {KEY_LEFT_ALT, KEY_TAB}}}}, // ALT+TAB
  {.pin =  6, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = {{.durationMs = 0, .key = {KEY_LEFT_GUI, KEY_2}}}}, //open taskbar 2, aka chrome
};
